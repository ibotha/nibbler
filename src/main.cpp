...
/*   Updated: 2019/06/25 12:36:56 by ibotha           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	glBufferData(GL_ELEMENT_ARRAY_BUFFER, 3, index_buffer, GL_STATIC_DRAW);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glDrawElements(GL_TRIANGLES, 3, GL_STATIC_DRAW, nullptr);
